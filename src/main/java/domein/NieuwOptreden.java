...
public class NieuwOptreden implements Serializable {
  ...
  @Range(min = 1000, max = 9999, message = "Festival-nummer 1 moet uit 4 cijfers bestaan tussen 1000 en 9999")
  private int festivalNummer1;

  @Min(value = 0, message = "Festival-nummer 2 moet groter of gelijk zijn aan festival-nummer1")
